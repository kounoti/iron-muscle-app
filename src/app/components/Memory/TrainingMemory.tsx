            ...
            {memories.map((memory: MemoryType) => (
              <tr key={memory.id}>
                ...
                <td className="text-center border">
                  {/* 投稿ボタン */}
                  <button
                    className="text-white bg-blue-100 hover:bg-blue-200 rounded-md p-1 flex items-center mb-1"
                  ...
                  {/* 削除ボタン */}
                  <button
                    className="text-white bg-red-100 hover:bg-red-200 rounded-md p-1 flex items-center"
